...
// Admin user email - this user will be automatically promoted to admin when they first sign in
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'darjsavid@gmail.com';
...
async function createAdminUser() {
  ...
  if (existingUser) {
    ...
    // Create new admin user (will be linked when they first sign in with GitHub)
...
async function main() {
  try {
    ...
    // Create categories and businesses
